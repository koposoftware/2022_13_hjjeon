...
const callData = async(location)=>{
  try {
     ...
     response =  await axios.post('/realty_market_price/roi',qs.stringify({date1:"2020",date2:"2020",location:location}));
    ...
    <div>
        <div className='mount3'> 
                ...
                <Nav.Item>
                 ...
                 <Nav.Item>
                    <Nav.Link eventKey="26" name="구로디지털공단역" onClick={clickLocation}>구로디지털공단역</Nav.Link>
                 </Nav.Item>
                 <Nav.Item>
                 ...
                 <Nav.Item>
                   <Nav.Link eventKey="32" name="잠실송파" onClick={clickLocation}>잠실송파</Nav.Link>
                 </Nav.Item>
                 <Nav.Item>

        ...
        options={
          {
                    ...
                    xaxis: {
                      categories: [
                        ...
                        props.data[8].researchDate,
                        props.data[9].researchDate,
                        props.data[10].researchDate,
                        props.data[11].researchDate,
                        props.data[12].researchDate,
                        props.data[13].researchDate,
                        props.data[14].researchDate,
                        props.data[15].researchDate,
                      ],
                      title: {
                        text: '분기'
                      }
          ...
          [
                    {
                      ...
                      data: [
                        ...
                        props.data[8].earningRate,
                        props.data[9].earningRate,
                        props.data[10].earningRate,
                        props.data[11].earningRate,
                        props.data[12].earningRate,
                        props.data[13].earningRate,
                        props.data[14].earningRate,
                        props.data[15].earningRate,

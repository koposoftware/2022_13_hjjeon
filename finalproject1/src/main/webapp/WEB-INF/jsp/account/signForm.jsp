                                    ...
                                    <ul class="faq-menu nav nav-fill nav-pills justify-content-center" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="payment-tab" data-bs-toggle="pill"
                                                ...
                                                aria-selected="false"><i id="checkIcon3"  class="fa-solid fa-circle-check" style="margin-right: 3px; color: red;"></i>종합계좌설정 약관</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="support-tab" data-bs-toggle="pill"
                                                ...
                                                aria-selected="false"><i id="checkIcon4" class="fa-solid fa-circle-check" style="margin-right: 3px; color: red;"></i>수익증권저축 약관</button>
                                        </li>
                                    </ul>
                                </div>
                                <!--end col-->
...
② 회사는 저축자가 거래를 시작하기 전에 저축자가 원하는 매매성립내용의 통지방법을 확인하여 이를 기록ㆍ유지하여야 한다.
                                ...
                                <div style="font-size: 20px; display: flex; justify-content: flex-end;">
                                		<p>서명</p>
                                	  <div class="sigPad1 signed">
					    					<div class="sigWrapper">
					    		  				<canvas class="pad" width="400px" height="120px" style="border: 1px black soild;"></canvas>
					    				</div>
					  				</div> 
                                </div>
                                <div class="col-lg-12">
                                    <div class="text-center mt-5">
                                        <a id="sign" href="#hireNow" data-bs-toggle="modal" class="btn btn-primary btn-hover mt-2"><i class="fa-solid fa-pen" style="margin-right: 5px;"></i>서명하기</a>
                                        <button id="next"  type="button" class="btn btn-warning btn-hover mt-2 ms-md-2"  disabled="disabled"><i class="fa-solid fa-angles-right" style="margin-right: 5px;"></i> 다음으로 이동</button>
                                    </div>   
                                </div>
                            </div><!--end row-->
                        </div><!--end container-->
                                    ...
                                    <div class="mb-4">
                                     <form method="post" action="" class="sigPad">
									    ...
									    <div class="sig sigWrapper" style="width: 400px;">
									      <canvas class="pad" width="400px" height="120px"  style="border: 1px black solid; margin: 3px; margin-top: 5px;"></canvas>
									      <input type="hidden" name="output" class="output">
									    </div>
									</form>
                                    </div>
                                    <button  type="button"id="successSign" class="btn btn-primary w-100" data-bs-dismiss="modal" aria-label="Close" style="margin-top: 100px;">완료</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <p class="text-white-50 text-center mb-0">
                                    <script>document.write(new Date().getFullYear())</script> &copy; Jobvia - Job Listing Page
		...
		$(document).ready(function() {
		      $('.sigPad').signaturePad({
		        ...
		        onDrawEnd :function (){
		          ...
		          $('.sigPad1').signaturePad({displayOnly:true}).regenerate(instance.getSignatureString());
		
		          }
		  			
		      });
		      $('#clearButton').on('click',function(){
	  				$('.sigPad1').signaturePad({displayOnly:true}).regenerate();
	  			})
	  			
	  			$('#successSign').on('click',function(){
	  				$('#next').removeAttr("disabled");
	  			})
	  			$('#next').on('click',function(){
	  				location.href='${pageContext.request.contextPath}/account/userAuth';
	  			})
    });

                                        ...
                                        <div class="row g-0">
                                            <div class="col-md-6">
                                                <div class="filter-search-form mt-3 mt-md-0">
                                                    ...
                                                    <select class="form-select" data-trigger name="buildingNo" id="choices-single-location" onchange="changeSelect()">
                                                        <option value="1000">하나가든타운</option>
                                                        <option value="1001">하나워커타워</option>
                                                        <option value="1002">하나물류창고</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!--end col-->
                                        ...
                                        <a class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false" style="margin-bottom: 40px;">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 text-start ms-3">
                                                    ...
                                                    <p class="text-muted mb-0">${subscription.POINT_DETAIL1}</p>
                                                </div>
                                            </div>
                                        </a>
                                        <a class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false" style="margin-bottom: 40px;">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 text-start ms-3">
                                                    ...
                                                    <p class="text-muted mb-0">${subscription.POINT_DETAIL2}</p>
                                                </div>
                                            </div>
                                        </a>
                                        <a class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                                            <div class=" d-flex">
                                                ...
                                                <div class="flex-grow-1 text-start ms-3">
                                                    ...
                                                    <p class="text-muted mb-0">${subscription.POINT_DETAIL3}</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="blog-box card p-2 mt-3">
                                        <div class="blog-img position-relative overflow-hidden" style="width: 100%;">
                                            ...
                                            <div class="author">
                                                <p class=" mb-0"><a href="javascript:void(0)" class="text-light user">${subscription.POINT_HEAD2}</a></p>
                                                <p class="text-light mb-0 date"><i class="mdi mdi-calendar-check"></i> 청약기간 2022.09.12-2022.09.26</p>
                                            </div>
                                            <div class="likes">
                                                <ul class="list-unstyled mb-0">

                                                    <li class="list-inline-item"><a href="javascript:void(0)" class="text-white"><i class="mdi mdi-comment-outline me-1"></i>전체 공모 금액 5,000,000,000(50억)</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <a  id="subscriptionBtn" href="#subscriptionModal" data-bs-toggle="modal" class="form-text" style="color: #089995;" onclick="getSubscription()">청약 신청하러 가기 <i class="mdi mdi-chevron-right align-middle"></i></a>
                                        </div>
                                    </div>
                                    <!--end blog-box-->
        ...
        $('#cafe2_subscription_done').hide()
       	function subscriptionProcess(){
            ...
            function getSubscription() {
                fetch('${pageContext.request.contextPath}/getSubscriptionProperty?propertyNo=10030000').then(
                    res => res.json()
                ).then(
                    response => {
                        console.log(response)
            ...
            function changeSelect() {
                if ($('#choices-single-location option:selected').val() == 1000) {
                    console.log('1000선택')
                    $('#propertyNo').val('10000000')
                } else if ($('#choices-single-location option:selected').val() == 1001) {
                    console.log('1001선택')
                    $('#propertyNo').val('10010400')
                } else {
                    $('#propertyNo').val('10020000')
                    console.log('1002선택')
                }

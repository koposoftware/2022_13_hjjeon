...
!(function (e, t) {
    ...
    function ie(e) {
        ...
        for ("string" == typeof e ? (i = e.split(/\s*,\s*/)) : "function" == typeof e ? (i = [e]) : Array.isArray(e) && (i = e), t = 0; t < i.length; t++)
            "string" == typeof (n = i[t]) ? r.push("-" === n.charAt(0) ? { field: n.substring(1), order: -1 } : { field: n, order: 1 }) : "function" == typeof n && r.push({ func: n });
        return r;
    }
    function oe(e, t, n) {
        var r, i;
    ...
    function st(e, t, n, r) {
        ...
        return { date: i, start: i, end: t ? ut(t, n.calendarSystem) : null, timeZone: n.timeZone, localeCodes: n.locale.codes, separator: r };
    }
    function ut(e, t) {
                ...
                (e.prototype.setProp = function (e, t) {
                    ...
                    if (e in Ft);
                        ...
                        "function" == typeof Ht[e] && (t = Ht[e](t)),
                            "color" === e ? (i = { backgroundColor: t, borderColor: t }) : "editable" === e ? (i = { startEditable: t, durationEditable: t }) : (((r = {})[e] = t), (i = r)),
            ...
            g &&
                ("inverse-background" === S.rendering
                    ? S.groupId
                        ? i[S.groupId].push(g)
                        : o[f.defId].push(g)
                    : ("background" === S.rendering ? s : u).push({ def: S, ui: p, instance: f, range: g, isStart: v.start && v.start.valueOf() === g.start.valueOf(), isEnd: v.end && v.end.valueOf() === g.end.valueOf() }));
        }
        for (var y in i)
    ...
    function ft(e, t, n) {
        ...
        r.hasPublicHandlers("eventRender") &&
            (t = t.filter(function (e) {
                var t = r.publiclyTrigger("eventRender", [{ event: new ct(r, e.eventRange.def, e.eventRange.instance), isMirror: n, isStart: e.isStart, isEnd: e.isEnd, el: e.el, view: i }]);
    ...
    function bt(e, t, n, r, i) {
        ...
        return (
            ...
            r.datesDelta && n.startEditable && (u.range = { start: o.add(u.range.start, r.datesDelta), end: o.add(u.range.end, r.datesDelta) }),
            r.startDelta && n.durationEditable && (u.range = { start: o.add(u.range.start, r.startDelta), end: u.range.end }),
            r.endDelta && n.durationEditable && (u.range = { start: u.range.start, end: o.add(u.range.end, r.endDelta) }),
    ...
    function Yt(e, t, n, r) {
        return { instanceId: String(Wt++), defId: e, range: t, forcedStartTzo: null == n ? null : n, forcedEndTzo: null == r ? null : r };
    }
                ...
                (e.prototype._splitInteraction = function (e) {
                    ...
                    if (e) {
                        var n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents)),
                            ...
                            o = function (r) {
                                t[r] || (t[r] = { affectedEvents: n[r] || Jt, mutatedEvents: i[r] || Jt, isEvent: e.isEvent, origSeg: e.origSeg });
                            };
                        for (var a in n) o(a);
                        for (var a in i) o(a);
                    }
    ...
    function $t(e, t, n, r, i) {
        ...
        return (
            ...
            (r = r
                ...
                : ""),
            (i = i || ""),
            !s && e.navLinks ? "<a" + r + ' data-goto="' + Pt(JSON.stringify(u)) + '">' + i + "</a>" : "<span" + r + ">" + i + "</span>"
        );
    }
    function en(e, t, n, r) {
        var i,
        ...
        return (
            Ze(t.activeRange, e)
                ? (c.push("fc-" + P[e.getUTCDay()]),
                  s.monthMode && l.getMonth(e) !== l.getMonth(t.currentRange.start) && c.push("fc-other-month"),
                  (o = x((i = B(a.getNow())), 1)),
                  e < i ? c.push("fc-past") : e >= o ? c.push("fc-future") : (c.push("fc-today"), !0 !== r && c.push(u.getClass("today"))))
            ...
            eventSourceDefs: [
                {
                    ...
                    fetch: function (e, t, n) {
                        ...
                        tn(
                            e.eventSource.meta.bind(null, { start: r.toDate(e.range.start), end: r.toDate(e.range.end), startStr: r.formatIso(e.range.start), endStr: r.formatIso(e.range.end), timeZone: r.timeZone }),
                            function (e) {
                                t({ rawEvents: e });
                            },
                            n
                ...
                parse: function (e, t, n) {
                    ...
                    if (s) {
                        ...
                        return (
                            ...
                            !l && a.startTime && a.endTime && ((r = a.endTime), (i = a.startTime), (l = { years: r.years - i.years, months: r.months - i.months, days: r.days - i.days, milliseconds: r.milliseconds - i.milliseconds })),
    ...
    var Pn = {
        ...
        week: { dow: 0, doy: 4 },
        dir: "ltr",
        buttonText: { prev: "이전", next: "다음", prevYear: "prev year", nextYear: "next year", year: "year", today: "오늘 ", month: "month", week: "week", day: "day", list: "list" },
        weekLabel: "W",
        allDayText: "all-day",
        eventLimitText: "more",
    ...
    var Fn = (function () {
            ...
            return (
                ...
                (e.prototype.createMarkerMeta = function (e) {
                    ...
                    var t = null;
                    return (
                        "number" == typeof e ? (t = this.timestampToMarker(e)) : e instanceof Date ? ((e = e.valueOf()), isNaN(e) || (t = this.timestampToMarker(e))) : Array.isArray(e) && (t = j(e)),
        ...
        switch (t.type) {
            ...
            case "RECEIVE_EVENT_ERROR":
                return (function (e, t, n, r) {
                    var i,
                        o = e[t];
                    if (o && n === o.latestFetchId) return Se({}, e, (((i = {})[t] = Se({}, o, { isFetching: !1, fetchRange: r })), i));
                    return e;
        ...
        return (
            ...
            (e.prototype.build = function (e, t, n) {
                ...
                return (
                    ...
                    (c = Fe(a.range, r)),
                    { validRange: r, currentRange: a.range, currentRangeUnit: a.unit, isRangeAllDay: s, activeRange: l, renderRange: u, minTime: i, maxTime: o, isValid: c, dateIncrement: this.buildDateIncrement(a.duration) }
                );
            }),
            ...
            (e.prototype.buildCurrentRangeInfo = function (e, t) {
                ...
                return (
                    r.duration
                        ? ((o = r.duration), (a = r.durationUnit), (s = this.buildRangeFromDuration(e, t, o, a)))
                        ...
                        : ((a = ne((o = this.getFallbackDuration())).unit), (s = this.buildRangeFromDuration(e, t, o, a))),
            ...
            (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
                ...
                return (
                    c || ((i = this.options.dateIncrement) ? ((o = J(i)), (c = te(o) < te(n) ? ne(o, !Q(i)).unit : r)) : (c = r)),
                                        ...
                                        "title" === e
                                            ...
                                            : ((r = f[e])
                                                  ? ((d = function (e) {
                                                    ...
                                                    (v = a.getCustomButtonIconClass(r)) || (v = a.getIconClass(e)) || (g = r.text))
                                                  : (s = c[e])
                                                  ? (n.viewsWithButtons.push(e),
                                                    (d = function () {
                                                        u.changeView(e);
                                                    }),
                                                    (g = s.buttonTextOverride) || (v = a.getIconClass(e)) || (g = s.buttonTextDefault))
                                                  : u[e] &&
                                                    ((d = function () {
                                                        u[e]();
                                                    }),
                                              ...
                                              d &&
                                                  ...
                                                  g ? ((y = Pt(g)), (S = "")) : v && ((y = "<span class='" + v + "'></span>"), (S = ' aria-label="' + e + '"')),
                                                  (E = i('<button type="button" class="' + m.join(" ") + '"' + S + ">" + y + "</button>")).addEventListener("click", d),
                                                  o.push(E)));
                                    }),
                                    o.length > 1)
                                ) {
        ...
        yr = (function (e) {
            ...
            return (
                ...
                (t.prototype._renderToolbars = function (e, t, n, r) {
                    ...
                    d ? (o || ((o = this.header = new gr("fc-header-toolbar")), u(this.el, o.el)), o.receiveProps(Se({ layout: d }, m), i)) : o && (o.destroy(), (o = this.header = null)),
                        f ? (a || ((a = this.footer = new gr("fc-footer-toolbar")), s(this.el, a.el)), a.receiveProps(Se({ layout: f }, m), i)) : a && (a.destroy(), (a = this.footer = null));
                }),
                ...
                (t.prototype.computeHeightVars = function () {
                    ...
                    } else this.viewHeight = Math.round(this.contentEl.getBoundingClientRect().width / Math.max(e.opt("aspectRatio"), 0.5));
                }),
    ...
    (Rr.prototype.classes = {
        ...
        (Rr.prototype.iconClasses = { close: "fc-icon-x", prev: "fc-icon-chevron-left", next: "fc-icon-chevron-right", prevYear: "fc-icon-chevrons-left", nextYear: "fc-icon-chevrons-right" }),
    ...
    var Cr = (function () {
        ...
        return (
            ...
            (e.prototype.render = function () {
                this.component ? this.requestRerender() : ((this.component = new yr(this.el)), (this.renderableEventStore = { defs: {}, instances: {} }), this.bindHandlers(), this.executeRender());
            }),
            (e.prototype.destroy = function () {
                if (this.component) {
            ...
            (e.prototype.dispatch = function (e) {
                if ((this.actionQueue.push(e), !this.isReducing)) {
                    ...
                    t.eventStore !== n.eventStore && t.eventStore && (this.isEventsUpdated = !0),
                        t.dateProfile !== n.dateProfile && (t.dateProfile && r && this.publiclyTrigger("datesDestroy", [{ view: r, el: r.el }]), (this.isDatesUpdated = !0)),
                        t.viewType !== n.viewType && (t.viewType && r && this.publiclyTrigger("viewSkeletonDestroy", [{ view: r, el: r.el }]), (this.isViewUpdated = !0)),
            ...
            (e.prototype.renderComponent = function () {
                ...
                t.receiveProps(
                    ...
                    this.isViewUpdated && ((this.isViewUpdated = !1), this.publiclyTrigger("viewSkeletonRender", [{ view: t.view, el: t.view.el }])),
                    this.isDatesUpdated && ((this.isDatesUpdated = !1), this.publiclyTrigger("datesRender", [{ view: t.view, el: t.view.el }])),
            ...
            (e.prototype.mutateOptions = function (e, t, n, r) {
                ...
                this.optionsManager.mutate(a, t, n),
                    ...
                    this.batchRendering(function () {
                        if ((d ? (l && i.dispatch({ type: "CHANGE_TIMEZONE", oldDateEnv: u }), i.dispatch({ type: "SET_VIEW_TYPE", viewType: i.state.viewType })) : c && i.updateSize(), r)) for (var e in s) o[e](s[e], i, r);
                    });
            }),
            ...
            (e.prototype.changeView = function (e, t) {
                var n = null;
                t && (t.start && t.end ? (this.optionsManager.mutate({ visibleRange: t }, []), this.handleOptions(this.optionsManager.computed)) : (n = this.dateEnv.createMarker(t))),
                    this.unselect(),
            ...
            (e.prototype.addEventSource = function (e) {
                if (e instanceof lt) return this.state.eventSources[e.internalEventSource.sourceId] || this.dispatch({ type: "ADD_EVENT_SOURCES", sources: [e.internalEventSource] }), e;
                var t = Yn(e, this);
    ...
    function Mr(e, t, n, r, i, o, a) {
        return new Fn({ calendarSystem: "gregory", timeZone: t, namedTimeZoneImpl: n, locale: e, weekNumberCalculation: i, firstDay: r, weekLabel: o, cmdFormatter: a });
    }
    function kr(e) {
        ...
        return (
            ...
            (t.prototype.startNowIndicator = function (e, t) {
                ...
                a.options.nowIndicator &&
                    ...
                    (i = u.add(u.startOf(this.initialNowDate, n), J(1, n)).valueOf() - this.initialNowDate.valueOf()),
            ...
            (t.prototype.stopNowIndicator = function () {
                this.nowIndicatorTimeoutID && (clearTimeout(this.nowIndicatorTimeoutID), (this.nowIndicatorTimeoutID = null)),
                    ...
                    this.isNowIndicatorRendered && (this.unrenderNowIndicator(), (this.isNowIndicatorRendered = !1));
            }),
        ...
        return (
            ...
            (e.prototype._getTimeText = function (e, t, n, r, i, o, a) {
                ...
                return (
                    ...
                    this.displayEventTime && !n ? (i && t ? s.formatRange(e, t, r, { forcedStartTzo: o, forcedEndTzo: a }) : s.format(e, r, { forcedTzo: o })) : ""
                );
            }),
            ...
            return (
                ...
                (e.prototype.renderSegHtml = function (e, t) {
                    var n = null,
                        r = [];
                    return (
                        "highlight" !== e && "businessHours" !== e && (n = { "background-color": t.eventRange.ui.backgroundColor }),
                        "highlight" !== e && (r = r.concat(t.eventRange.ui.classNames)),
                        "businessHours" === e ? r.push("fc-bgevent") : r.push("fc-" + e.toLowerCase()),
                        "<" + this.fillSegTag + (r.length ? ' class="' + r.join(" ") + '"' : "") + (n ? ' style="' + xt(n) + '"' : "") + "></" + this.fillSegTag + ">"
                    );
                }),
    ...
    function Wr(e, t, n, r, i, o, a, s) {
        ...
        return (
            (u = "function" == typeof d.columnHeaderHtml ? d.columnHeaderHtml(l.toDate(e)) : "function" == typeof d.columnHeaderText ? Pt(d.columnHeaderText(l.toDate(e))) : Pt(l.format(e, i))),
    ...
    var Zr = (function (e) {
        ...
        jr = (function () {
            function e(e, t) {
                for (var n = e.start, r = e.end, i = [], o = [], a = -1; n < r; ) t.isHiddenDay(n) ? i.push(a + 0.5) : (a++, i.push(a), o.push(n)), (n = x(n, 1));

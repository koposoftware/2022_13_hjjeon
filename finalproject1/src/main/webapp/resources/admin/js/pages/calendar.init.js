!(function (g) {
    ...
    (e.prototype.init = function () {
        ...
        var c = [
                { title: "서초워커타워 배당금 지급일", start: new Date(o, d, 3,10,0), className: "bg-success" },
                 { title: "이태원월드컴포트 공모모집", start: new Date(o, d, 18,10,0), end: new Date(o, d, 25,10,0), className: "bg-info" },
                 { title: "김포하나물류창고 매각투표 시작", start: new Date(o, d, 18,10,0),  className: "bg-danger" },
        ...
        function u(e) {
            l.modal("show"), a.removeClass("was-validated"), a[0].reset(), g("#event-title").val(), g("#event-category").val(), t.text("일정 추가하기"), (r = e);
        }
        var m = new FullCalendar.Calendar(v, {
            ...
            eventClick: function (e) {
                l.modal("show"), a[0].reset(), (i = e.event), g("#event-title").val(i.title), g("#event-category").val(i.classNames[0]), (r = null), t.text("일정 수정하기"), (r = null);
            },
